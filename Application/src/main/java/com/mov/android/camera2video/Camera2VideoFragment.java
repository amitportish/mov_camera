...
import com.mov.android.camera2video.CountDownAnimation;
...
public class Camera2VideoFragment extends Fragment
    ...
    /**
     * An {@link CountDownAnimation} for animating 3-2-1-go before video recording
     */
    ...
    private static final String ISFRONT_KEY = "isFrontCamera";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mIsFrontCamera = (boolean) getArguments().getSerializable(ISFRONT_KEY);
        mDuration = (int) getArguments().getSerializable(DURATION_KEY);
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        mCountDownAnimation = new CountDownAnimation( (TextView) getView().findViewById(R.id.pre_record), 3);
        mCountDownAnimation.setCountDownListener(this);

        mCountDownTimer = new CountDownTimer(mDuration,100) {
